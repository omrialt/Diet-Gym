...
const EditProgramPage = () => {
  ...
  const trainingUpdate = useSelector((state) => state.trainingUpdate);
  const {
  ...
  useEffect(() => {
    document.title = "Diet&Gym|Update Program";
    if (!training._id) {
    ...
    if (!userInfo || successUpdate) {
      ...
      setExercises(training.exercise);
      setImage(training.image);
    }
  }, [
    userInfo,
    successUpdate,
    ...
    <>
      {loading || loadingUpdate ? (
        ...
        <div className="create-program-page mt-3">
          <h2 className="px-5">{t("pages.newPosts.training.update")}</h2>
          <Form
          ...
          >
            ...
            <span className="table-title">
              {t("pages.newPosts.training.exercise")}
            </span>
            <Table>
              <thead>
                <tr>
            ...
            <div className="d-flex">
              ...
              <Button
                type="submit"
                text={t("pages.newPosts.training.update")}
                className="create-button"
              ></Button>
              <Button
                type="button"
                text={t("pages.newPosts.training.delete")}
                className="delete-button"
                onClickFn={deleteProgram}
              ></Button>
            </div>
          </Form>
        </div>
